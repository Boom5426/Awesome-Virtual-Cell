...
- **[VCDesign]** `[Intervention Design]` `[Perturbation]` `[Virtual Cell]` VCDesign: Candidate-Conditioned Inverse Modeling for Cellular Intervention Design (**Manuscript 2026**) [[preprint](https://github.com/Boom5426/VCDesign-CED/blob/main/paper/VCDesign.pdf)] [[code](https://github.com/Boom5426/VCDesign-CED)] ![GitHub stars](https://img.shields.io/github/stars/Boom5426/VCDesign-CED.svg?logo=github&label=Stars) [[project](https://boom5426.github.io/VCDesign-CED/)] [[dataset](https://huggingface.co/datasets/Boom5426/VCDesign)]
